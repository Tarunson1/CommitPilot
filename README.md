...
![aic example usage](./assets/example-usage.svg)
...
export OPENAI_API_KEY=<your-api-key> # optional — only if your custom provider requires one
```
...
make check  # run ruff lint checks
```
