...
def parse_host(host: str | None = None) -> str:
    ...
    try:
        ...
        # e.g. a bare/unbracketed IPv6 address like "::1" instead of "[::1]"
        print(
            f"⚠️  Could not parse OLLAMA_HOST={host!r}, falling back to 127.0.0.1:11434. "
            "Wrap IPv6 addresses in brackets, e.g. [::1]."
        )
